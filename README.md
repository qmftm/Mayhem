...
| <img src="docs/icons/redstone.png" width="128"> | 죄책감의 쾌락 | 적을 처치하면 체력을 회복합니다. |
| <img src="docs/icons/blaze_powder.png" width="128"> | 주님의 사랑 | 검을 우클릭해 화염구를 연달아 발사합니다. |
| <img src="docs/icons/sugar.png" width="128"> | 클린업 | 체력이 낮은 적이 가까이 있으면 이동 속도가 빨라집니다. |
| <img src="docs/icons/cooked_porkchop.png" width="128"> | 포화지방산 | 배고픔이 줄지 않고, 음식을 먹으면 즉시 체력을 회복합니다. |
| <img src="docs/icons/obsidian_iso.png" width="128"> | 흑섬 | 공격할 때 확률로 강력한 치명타를 터뜨립니다. |
...
| <img src="docs/icons/jukebox_iso.png" width="128"> | 탭 댄서 | 공격할 때마다 이동 속도가 누적되며, 일정 시간 공격하지 않으면 빠르게 사라집니다. |
