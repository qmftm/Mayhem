...
<tr><td align="center"></td><td>필연적인 존재</td><td>적을 처치할 때마다 50% 확률로 6종의 스톤(파워, 스페이스, 리얼리티, 소울, 타임, 마인드) 중 하나를 무작위로 획득합니다. 모두 모은 뒤 건틀릿을 우클릭하면 1회에 한해 모든 적을 즉사시키고 모든 스톤이 소멸합니다. 각 스톤은 왼손에 들고 있을 때만 효과가 발동하며, 파워는 공격력 +100%, 스페이스는 이동 속도 +100%, 리얼리티는 투명화, 소울은 공격의 50% 고정 피해, 타임은 공격 속도 +50%, 마인드는 공격한 적에게 5초간 매혹을 부여합니다.</td></tr>
</tbody>
</table>
