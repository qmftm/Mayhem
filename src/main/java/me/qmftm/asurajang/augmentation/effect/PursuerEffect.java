...
public class PursuerEffect implements AugmentationEffect {
    ...
    public void onDamageAsAttacker(Player player, EntityDamageByEntityEvent event) {
        ...
        int maxStacks = AugmentSettings.getInt("Pursuer", "max-stacks", 10);
        double damagePerStack = AugmentSettings.getDouble("Pursuer", "damage-per-stack", 0.05);
